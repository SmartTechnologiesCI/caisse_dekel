report 70010 "Palmarès client"
{
    RDLCLayout = 'Reports\RDLC\Report 700010 Palmarès Client.rdlc';
    Caption = 'Palmarès Client';
    ...
    var
        Text000: Label 'Trier les clients    #1##########';
        Text001: Label 'Période: %1';
        Text002: Label 'Ranger par %1';
        ...
        CustomerTop10ListCaptionLbl: Label 'Palmarès clients';
        CurrReportPageNoCaptionLbl: Label 'Page';
        TotalCaptionLbl: Label 'Total';
        TotalSalesCaptionLbl: Label 'Total Ventes';
        PercentofTotalSalesCaptionLbl: Label '% Total ventes';
        NoOfRecordsToPrintErrMsg: Label 'La valeur doit être positive';
