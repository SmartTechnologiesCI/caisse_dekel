report 70018 "Vendor - Top 10 List ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\RDLC\Report 70018 Palmarès fournisseur.rdlc';
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(Show; ShowType)
                    {
                        ApplicationArea = Suite;
                        Caption = 'afficher';
                        OptionCaption = 'Achat (DS),Solde (DS)';
    ...
    var
        ...
        BarText: Text[50];
        i: Integer;
        Text004: TextConst ENU = 'Purchases (LCY),Balance (LCY)', FRA = 'Achats (DS),Solde (DS)';
